...
# What is the name of this app?
	define('APP_NAME', 'Online Form');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'professorlarryadams@gmail.com'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'professorlarryadams@gmail.com'); 

# Default DB name for this app
	define('DB_NAME', 'allthin1_p3_allthingseuropean_com'); 
...
# For this you could use gmail SMTP or something like http://sendgrid.com/
	...
	define('SMTP_USERNAME', 'professorlarryadams@gmail.com');
	define('SMTP_PASSWORD', 'F0rget1964');
